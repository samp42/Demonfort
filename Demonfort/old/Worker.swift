...
//                } else {
                    for document in querySnapshot!.documents {
                        ...
                        self.i+=1
                        if(self.i>self.numOfDocuments){
                            self.numOfDocuments = self.i
                        }
                    }
                //}
            } else {
        ...
        //retrieve user's workPlaces
//        database.collection("employees").whereField("Employee", isEqualTo: "Samuel Proulx").order(by: "StartTime", descending: true).getDocuments{ (querySnapshot, error) in
//                    
//            if error == nil && querySnapshot != nil{
//                if let error = error {
//                    print("Error getting documents: \(error)")
...
//            }
//        }// end of database.getDocuments
        print("NUM OF DOCUMENTS\(self.numOfDocuments)")
    }//end of init
